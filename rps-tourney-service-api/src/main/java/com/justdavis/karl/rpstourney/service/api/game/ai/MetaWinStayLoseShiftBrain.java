...
/**
 * This {@link IPositronicBrain} is referred to as "the best way to win", per
 ...
 * this <strong>isn't</strong> the "win-stay, lose-shift" strategy that is
 * referred to there; it's the strategy designed to beat that one.
 */
public final class MetaWinStayLoseShiftBrain implements IPositronicBrain {
	...
	public Throw calculateNextThrow(GameView game, PlayerRole role) {
		...
		/*
		 * "... if you lose the first round, switch to the thing that beats the
		 * thing your opponent just played. If you win, don't keep playing the
		 * same thing, but instead switch to the thing that would beat the thing
