...
/**
 * This service allows users to login as a guest. See
...
public interface IGuestAuthResource {
	 ...
	 * and will have a "blank" {@link Account} created for it.
	 * </p>
	 * <p>
	 * If the user/client calling this method is already logged in, this method
	 * will return an error, rather than overwriting the existing login (users
	 * must manually log out, first).
	 * </p>
	 * 
