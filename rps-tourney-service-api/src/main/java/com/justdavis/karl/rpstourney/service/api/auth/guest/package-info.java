/**
 * Contains the types related to the guest authentication code, which persists user data across requests and sessions,
 * but doesn't require an explicit login.
 */
