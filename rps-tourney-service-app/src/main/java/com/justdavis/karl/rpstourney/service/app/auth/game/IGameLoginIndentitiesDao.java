...
public interface IGameLoginIndentitiesDao {
	/**
	 * @param login
	 *            the {@link GameLoginIdentity} instance to be inserted/updated in the database
	 */
	void save(GameLoginIdentity login);

	/**
	 * @param emailAddress
	 *            the email address to match against {@link GameLoginIdentity#getEmailAddress()}
	 * @return the {@link GameLoginIdentity} that matches the specified parameters, or <code>null</code> if no match was
	 *         found
	 */
