...
/**
 * <p>
 * This Spring {@link Component} runs the application's {@link IDataSourceSchemaManager} during its bean initialization.
 * </p>
 * <p>
 * This is admittedly a bit of a hack. It would be more appropriate to run this after Spring initialization, but before
 * the webapp context has completed startup (e.g. as a {@link ServletContextListener}). However, this proved to not be
 * possible as Spring cannot lazy-load the application's {@link EntityManagerFactory}, which validates the schema as
 * part of its initialization: the schema has to be populated before that happens.
 * </p>
 *
...
public class DatabaseSchemaInitializer {
	...
	/**
	 * <p>
	 * Runs {@link IDataSourceSchemaManager#createOrUpgradeSchema(IDataSourceCoordinates)} .
	 * </p>
	 * <p>
