...
/**
 * <p>
 * The Spring {@link Configuration} required by this project's DAOs (and their
 * ITs).
 * </p>
 * <p>
 * Design Note: This specifically does <strong>not</strong> import
 * {@link SpringBindingsForJpa}, as the DAO ITs manage all of that themselves.
 * Instead, that is included in {@link SpringBindingsForWebServices}.
 * </p>
 */
@Configuration
