...
public final class DatabaseSchemaUpgradeIT {
	...
	/**
	 * Tests {@link IDataSourceSchemaManager} when run against a schema that's
	 * already correct. Basically, just verifies that the Liquibase checksum
	 * handling is correct.
	 */
	@Test
	public void updateSchema() {
		...
		/*
		 * The DaoTestHelper has already run this once, so just run it a second
		 * time.
		 */
