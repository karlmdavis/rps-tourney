...
public final class WebClientHelper {
	...
	/**
	 * Enables/disables the {@link WebClient}'s session maintenance, which will
	 * persist cookies and other state between web client calls. Defaults to
	 * <code>false</code>.
	 * 
	 * @param client
	...
	/**
	 * Enables/disables the {@link WebClient}'s "permissive SSL trust" mode,
	 * which will accept any/all server SSL certificates, regardless of their
	 * validity. Defaults to <code>false</code>.
	 * 
	 * @param client
	 *            the {@link WebClient} to modify
	 ...
	 * </p>
	 * <p>
	 * This {@link X509TrustManager} implementation can be used by clients, and
	 * will accept <em>all</em> server certificates, regardless of their actual
	 * validity.
	 * </p>
	 */
