...
p2Repos_m2e_apt=http://download.jboss.org/jbosstools/updates/m2e-extensions/m2e-apt
p2Repos=$p2Repos_base,$p2Repos_m2e_wtp,$p2Repos_markdown,$p2Repos_m2e_apt
...
# * [Annotation Processing support in m2e](https://community.jboss.org/en/tools/blog/2012/05/20/annotation-processing-support-in-m2e-or-m2e-apt-100-is-out)
$installationDirectory/eclipse -nosplash \
  ...
  -installIU org.jboss.tools.maven.apt.feature.feature.group           `# m2e APT configurator. Automagically configures annotation processing for Maven projects.`
