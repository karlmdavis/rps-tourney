...
/**
 * This Args4J {@link OptionHandler} handles parsing of
 * {@link InternetAddress} instances from {@link String}s.
 */
public final class InternetAddressOptionHandler extends
		OptionHandler<InternetAddress> {
	/**
	 * Constructs a new {@link InternetAddressOptionHandler} instance.
	 * 
	 * @param parser
	 *            the {@link CmdLineParser} that this {@link OptionHandler}
	 *            will be used with
	 * @param option
	 ...
	 */
	public InternetAddressOptionHandler(CmdLineParser parser,
			OptionDef option, Setter<? super InternetAddress> setter) {
