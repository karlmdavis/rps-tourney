...
/**
 * This checked exception is used to signal that an error condition has occurred
 * that should cause the game application to exit with the code specified in
 * {@link #getExitCode()}.
 */
public final class ConsoleGameExitException extends Exception {
	...
	/**
	 * @return the {@link System#exit(int)} code that the game application
	 *         should exit with
	 */
